<?php
	...
	unset($_SESSION['MM_Usernametrack']);
?>
<html>
<head>
		...
		<td colspan="12"><table width="100%" border="0">
          ...
          <tr>
            <td height="284"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="263" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center">Thanks, Page exit successful.</td>
                  </tr>
                  <tr>
                    <td align="center">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center"><a href="Track_Package_online.php">Enter your Tracking number again </a> </td>
                  </tr>
                  <tr>
                    <td></td>
                  </tr>
